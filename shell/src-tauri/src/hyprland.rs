...
/// Stub for non-Linux platforms where Hyprland is not available.
#[cfg(not(target_os = "linux"))]
#[tauri::command]
pub fn pop_out_tool(_tool: String) -> Result<(), String> {
    Err("pop_out_tool requires Hyprland (Linux only)".into())
}
